...
function _typeof(n) {
    ...
    var i, R = n.document,
        ...
        e = function(n, e, a) {
            console.warn("%cHC Off-canvas Nav:%c " + a + "%c '" + n + "'%c is now deprecated and will be removed in the future. Use%c '" + e + "'%c option instead. See details about plugin usage at https://github.com/somewebmedia/hc-offcanvas-nav.", "color: #fa253b", "color: default", "color: #5595c6", "color: default", "color: #5595c6", "color: default")
        },
        dn = 0;
    J.fn.extend({
        hcOffcanvasNav: function() {
            ...
            return this.each(function() {
                ...
                if (e.find("ul").addBack("ul").length) {
                    var n, o, i, c, t, a, s, l, y = "hc-nav-".concat(++dn),
                        r = (n = "hc-offcanvas-".concat(dn, "-style"), o = J('<style id="'.concat(n, '">')).appendTo(J("head")), i = {}, c = {}, t = function(n) {
                        ...
                        S = !1,
                        B = [];
                    e.addClass("hc-nav-original ".concat(y)), z.customToggle ? f = J(z.customToggle).addClass("hc-nav-trigger ".concat(y)).on("click", _) : (f = J('<a href="#" aria-label="Open Menu" class="hc-nav-trigger '.concat(y, '"><span></span></a>')).on("click", _), e.after(f));
                    var A = function(n, e, a) {
                            if ("number" == typeof e && ("number" == typeof n || B.length)) {
                                var t = '[tabindex=0], a[href], button, textarea, input[type="text"], input[type="radio"], input[type="checkbox"], select',
                                    o = v.find(".nav-wrapper").filter("[data-level=".concat(e, "]")).filter(function() {
                                        return "number" != typeof a || J(this).is("[data-index=".concat(a, "]"))
                                    }).children(".nav-content").children("ul").children("li").children(":not(.nav-wrapper)").find(t).addBack(t).filter(":not([tabindex=-1])");
                                if (o.length) {
                                    var i = o.first(),
                                        c = o.last();
                                    "number" == typeof n ? o.eq(n).focus() : (B[B.length - 1].focus(), B.pop()), Z.off(d), Z.on(d, function(n) {
                                ...
                                return n.each(function() {
                                    ...
                                    void 0 !== n.attr("data-nav-active") && (b = e, n.removeAttr("data-nav-active")), n.children("li").each(function() {
                                        var n = J(this),
                                            ...
                                            a = e ? n.children() : n.children().filter(function() {
                                                var n = J(this);
                                            ...
                                            i = null;
                                        o.length && (n.data("hc-uniqid") ? i = n.data("hc-uniqid") : (i = Math.random().toString(36).substr(2), n.data("hc-uniqid", i))), c.items.push({
                                            id: i,
                                            classes: n.attr("class") || null,
                                            content: a,
                        ...
                        D = function(n) {
                            n && (v.empty(), w = {}),
                                function h(n, e, m, g, a, t) {
                                    var b = J('<div class="nav-wrapper nav-wrapper-'.concat(m, '" data-level="').concat(m, '" data-index="').concat(a || 0, '">')).appendTo(e).on("click", on),
                                        o = J('<div class="nav-content">').appendTo(b);
                                    if (g && o.prepend("<h2>".concat(g, "</h2>")), J.each(n, function(n, e) {
                                            var u = J('<ul role="menu" aria-level="'.concat(m + 1, '">')).addClass(e.classes).appendTo(o);
                                            0 === n && g && u.attr("aria-label", g), e.id && u.attr("aria-labelledby", "menu-" + e.id), J.each(e.items, function(n, e) {
                                                var a = e.content;
                                                if (e.custom) {
                                                    var t = J('<li class="custom-content">').addClass(e.classes).append(J('<div class="nav-item nav-item-custom">').append(a.clone(!0, !0)));
                                                    u.append(t)
                                                } else {
                                                    var o = a.find("a").addBack("a"),
                                                        i = o.length ? o.clone(!1, !0).addClass("nav-item") : J("<".concat(e.subnav.length ? 'a href="#"' : "span", ' class="nav-item">')).append(a.clone(!0, !0)).on("click", on);
                                                    i.is("a") && i.attr("tabindex", "0").attr("role", "menuitem"), o.length && i.on("click", function(n) {
                                                        ...
                                                        n.preventDefault()
                                                    }), z.closeOnClick && (q() ? i.filter("a").filter('[data-nav-close!="false"]:not([disabled])').filter(function() {
                                                        var n = J(this);
                                                        return !e.subnav.length || n.attr("href") && "#" !== n.attr("href").charAt(0)
                                                    }).on("click", W) : i.filter("a").filter('[data-nav-close!="false"]:not([disabled])').on("click", W));
                                                    ...
                                                    if (e.subnav.length) {
                                                        ...
                                                        if (w[r] || (w[r] = 0), c.addClass("nav-parent"), q()) {
                                                            var p = function(n) {
                                                                    ...
                                                                    }).attr("aria-controls", "menu-" + s).attr("aria-haspopup", "overlap" === z.levelOpen).attr("aria-expanded", !1)
                                                                },
                                                                v = w[r],
                                                                f = J('<input type="checkbox" id="'.concat(y, "-").concat(r, "-").concat(v, '" class="hc-chk" tabindex="-1">')).attr("data-level", r).attr("data-index", v).val(s).on("click", on).on("change", j).prependTo(c); - 1 !== T.indexOf(s) && (b.addClass("sub-level-open").on("click", function() {
                                                                return Q(r, v)
                                                            }), c.addClass("level-open"), f.prop("checked", !0)), d = !0 === z.levelTitles ? a.text().trim() : "", i.attr("href") && "#" !== i.attr("href") ? p(J('<a href="#" class="nav-next" aria-label="'.concat(d, ' Submenu" role="menuitem" tabindex="0">')).on("click", on).insertAfter(i)) : (J('<span class="nav-next">').appendTo(i), p(i))
                                        ...
                                        l.children("a").on("click", cn(r)).on("keydown", function(n) {
                                            "Enter" !== n.key && 13 !== n.keyCode || (S = !0)
                                        }).wrap('<div class="nav-item-wrapper">'), !0 === z.insertBack ? i.first().prepend(l) : an(z.insertBack) && ln(l, z.insertBack, i)
                                    }
                                    if (0 === m && !1 !== z.insertClose) {
                                        var s = o.children("ul"),
                                            d = J('<li class="nav-close"><a href="#" role="menuitem" tabindex="0">'.concat(z.labelClose || "", "<span></span></a></li>"));
                                        d.children("a").on("click", cn(W)).on("keydown", function(n) {
                                            "Enter" !== n.key && 13 !== n.keyCode || N()
                                        }).wrap('<div class="nav-item-wrapper">'), !0 === z.insertClose ? s.first().prepend(d) : an(z.insertClose) && ln(d, z.insertClose, s.first().add(s.first().siblings("ul")))
                                    }
                                }(h, v, 0, z.navTitle)
                        };
                    f.attr("role", "button").attr("aria-controls", y).on("keydown", function(n) {
                        "Enter" !== n.key && 13 !== n.keyCode || setTimeout(function() {
                            A(0, 0)
                        }, 0)
                    }), Z.on("keydown", function(n) {
                        if (I() && ("Escape" === n.key || 27 === n.keyCode)) {
                            var e = T.length ? v.find(".hc-chk").filter("[value=".concat(T[T.length - 1], "]")).data("level") : !!I() && 0;
                            0 === e ? (W(), N()) : (Q(e), A(null, e - 1))
                        }
                    }), P(), M(), D(), !0 === z.removeOriginalNav && e.remove(), "prepend" === z.bodyInsert ? $.prepend(p) : "append" === z.bodyInsert && $.append(p), !0 === z.expanded && (g = !0, L());
                    var H = function(n, e, a) {
                        ...
                        if (t.length) {
                            ...
                            if (t.prop("checked", !1), c.removeClass("sub-level-open"), i.removeClass("level-open"), i.children(".nav-item-wrapper").children("[aria-controls]").attr("aria-expanded", !1), -1 !== T.indexOf(o) && T.splice(T.indexOf(o), 1), a && "overlap" === z.levelOpen && (c.off("click").on("click", on), sn(v, (n - 1) * z.levelSpacing, z.position), u)) {
                    ...
                    }, U.isOpen = I, U.open = L, U.close = W, U.update = function(n, e) {
                ...
                function L(n, e) {
                    if ((!I() || void 0 !== e) && (function() {
                            if (m = !0, p.css("visibility", "visible").attr("aria-hidden", !1).addClass(V), f.addClass("toggle-open"), "expand" === z.levelOpen && O && clearTimeout(O), z.disableBody && (x = X.scrollTop() || Y.scrollTop() || $.scrollTop(), R.documentElement.scrollHeight > R.documentElement.clientHeight && Y.addClass("hc-nav-yscroll"), $.addClass("hc-nav-open"), x && $.css("top", -x)), u) {
                        ...
                        if (a && a.length) {
                            var t = [];
                            n = a.data("level"), e = a.data("index"), 1 < n && (a.parents(".nav-wrapper").each(function() {
                                var n = J(this),
                                    e = n.data("level");
                                0 < e && t.push({
                                    level: e,
                ...
                function W() {
                    if (I()) {
                        if (m = !1, u && sn(u, 0), p.removeClass(V).attr("aria-hidden", !0), v.removeAttr("style"), f.removeClass("toggle-open"), "expand" === z.levelOpen && -1 !== ["top", "bottom"].indexOf(z.position) ? Q(0) : q() && (O = setTimeout(function() {
                                Q(0)
                            }, "expand" === z.levelOpen ? s : 0)), z.disableBody && ($.removeClass("hc-nav-open"), Y.removeClass("hc-nav-yscroll"), x)) {
                ...
                function F(n, e) {
                    ...
                    if (!1 === a && l.css("transition", "none"), t.prop("checked", !0), c.addClass("sub-level-open"), i.addClass("level-open"), i.children(".nav-item-wrapper").children("[aria-controls]").attr("aria-expanded", !0), !1 === a && setTimeout(function() {
                            l.css("transition", "")
                        }, s), -1 === T.indexOf(o) && T.push(o), "overlap" === z.levelOpen && (c.on("click", function() {
                            return Q(n, e)
                        }), sn(v, n * z.levelSpacing, z.position), u)) {
